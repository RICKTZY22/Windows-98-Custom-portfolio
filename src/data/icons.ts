...
export const win98Icons: Record<IconKey, string> = {
  ...
  networkDriverFile: `${iconBase}/network_drive-1.png`,
  inputDriverFile: `${iconBase}/keyboard-2.png`,
