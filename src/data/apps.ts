...
export const appDefinitions: Record<AppId, AppDefinition> = {
  ...
  happy99: {
    ...
    icon: 'execFile',
    defaultRect: { x: 200, y: 120, width: 440, height: 380 },
    singleton: false,
  },
  bonzi: {
    id: 'bonzi',
  ...
  cascade: {
    id: 'cascade',
    title: 'Cascade Effect - 1990 Virus Sim',
    icon: 'textFile',
    defaultRect: { x: 160, y: 80, width: 560, height: 420 },
    singleton: false,
  },
  netbus: {
    id: 'netbus',
    title: 'NetBus 1.70 - Remote Administrator',
    icon: 'network',
