...
const resumeDocumentContent = [
  ...
  '',
  'PROJECT EXPERIENCE',
  'Windows 98 Web Edition — Creative Frontend Developer',
  'React 19 · TypeScript · Vite · Virtual Filesystem · Browser OS',
  '- Built a fully interactive browser-based Windows 98-style web OS with a virtual filesystem, movable windows, and simulated desktop apps — Explorer, Notepad, Paint, and MS-DOS Prompt.',
...
export const portfolioData = {
  profile: {
    ...
    highlights: [
      ...
      'Creative builds: Between Two Ruins (animated visual novel) and this Windows 98 Web Edition',
  ...
  credits: [
    {
      ...
      note: 'Portfolio owner, project developer, resume subject, and creator of PLMun Inventory Nexus, Canlas Inventory System, Between Two Ruins, and the Windows 98 Web Edition direction.',
    },
    {
      section: 'Portfolio & tooling',
      label: 'OpenAI',
